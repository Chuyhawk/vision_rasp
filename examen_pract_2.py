...
# ================================
# CONFIGURACIÓN GPIO HACIA UR
# ================================
# IMPORTANTE:
# La Raspberry trabaja a 3.3V.
# NO conectes GPIO directo al UR.
# Usa un módulo relevador / optoacoplador de 3.3V.
# Del lado del UR, configura dos entradas digitales:
#   DI0 -> OK
#   DI1 -> SCRAP
...
class URDigitalBridge:
    def __init__(self, enabled=True, gpio_ok=17, gpio_scrap=27):
